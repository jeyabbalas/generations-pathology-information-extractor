...
`},{role:"user",content:n.prompt}],temperature:this.temperature,seed:this.seed+s}),a=i.choices[0].message.content,r=a.match(o),r)return JSON.parse(r[1]);s++}return console.error("Failed to extract valid JSON after 3 attempts, object with all missing values."),n.default}}function J(t){let e=document.getElementById(t);e.innerHTML=`
<!-- Header -->
